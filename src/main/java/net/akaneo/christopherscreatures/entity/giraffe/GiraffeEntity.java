...
public class GiraffeEntity extends TamableAnimal implements IAnimatable {
    ...
    public GiraffeEntity(EntityType<? extends TamableAnimal> entityType, Level level) {
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob mob) {
        return EntityMain.GIRAFFE.get().create(serverLevel);
    }
